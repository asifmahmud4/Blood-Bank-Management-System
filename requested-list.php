    ...
    <div id="full">
        <div id="inner_full">
            ...
            <div id="Body">
                ...
                ?>
                <h1 align="center" style="border:5px;color:white;background-color:brown">Donor List</h1>
                <center><div id="form">
                    <table>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                            <button><a href="delete-request.php?id=<?php echo $row['id']; ?>">Delete</a></button>
                            <button><a href="admin-approval.php?id=<?php echo $row['id']; ?>">Accept</a></button>
                                </td>
